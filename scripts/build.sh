...
for option in CONFIG_SMP CONFIG_X86_LOCAL_APIC CONFIG_X86_IO_APIC CONFIG_ACPI \
    ...
    CONFIG_BLK_DEV CONFIG_VIRTIO_PCI CONFIG_VIRTIO_BLK CONFIG_EXT4_FS \
    CONFIG_DRM CONFIG_DRM_VIRTIO_GPU CONFIG_DRM_VIRTIO_GPU_KMS \
    CONFIG_DRM_FBDEV_EMULATION CONFIG_FRAMEBUFFER_CONSOLE \
    CONFIG_INPUT_EVDEV CONFIG_VIRTIO_INPUT; do
