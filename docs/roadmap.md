...
Этапы 1–3 выполнены и проверены в WSL2/QEMU.
Следующий scope — этап 4: базовая система поверх устойчивого rootfs.
...
диск и установщик относятся к более поздним этапам.
